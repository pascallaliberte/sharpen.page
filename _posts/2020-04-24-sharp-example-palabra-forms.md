...
A landing page has good [_flow_][best-order] when each section answers the questions the one above raised. Where you start depends on the audience:
...
_Edit: The Palabra forms page shown here is no longer live, and the screenshots are from when it was._

![The top of the page doesn't need to focus on a struggle, since the audience has an established mindset for the solution. But it still addresses the struggle: nothing ugly please.](/assets/images/posts/2020-04-24-sharp-example-palabra-forms-01.jpg)
{: .img-zoom }

Palabra had this landing page for forms. It wasn't its main home page, but forget that part for a minute.
...
![The three steps... got it, scroll](/assets/images/posts/2020-04-24-sharp-example-palabra-forms-02.jpg)
{: .img-zoom }
...
![Ah, ok, it demos the output and the options by allowing me to edit the code, smart](/assets/images/posts/2020-04-24-sharp-example-palabra-forms-03.jpg)
{: .img-zoom }
...
![More proof it delivers on the "no ugly styles" promise](/assets/images/posts/2020-04-24-sharp-example-palabra-forms-04.jpg)
{: .img-zoom }
...
![Reveal: it's not just to collect emails, it lets you send emails too.](/assets/images/posts/2020-04-24-sharp-example-palabra-forms-05.jpg)
{: .img-zoom }
...
![The page finishes with the pricing information](/assets/images/posts/2020-04-24-sharp-example-palabra-forms-06.jpg)
{: .img-zoom }
